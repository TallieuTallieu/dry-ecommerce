...
it('takes no interest in an order it did not write', function (): void {
    ...
    $foreign = new class implements Tnt\Ecommerce\Contracts\OrderInterface {
        public function add(
            Tnt\Ecommerce\Contracts\CartItemInterface $cartItem
        ) {}
        ...
        public function setCustomer(
            Tnt\Ecommerce\Contracts\CustomerInterface $customer
        ) {}

        public function getCustomer(): Tnt\Ecommerce\Contracts\CustomerInterface
        {
            throw new LogicException('Not needed for this test.');
        }

        public function setFulfillment(
            Tnt\Ecommerce\Contracts\FulfillmentInterface $fulfillmentMethod
        ) {}

        public function getFulfillment(): Tnt\Ecommerce\Contracts\FulfillmentInterface
        {
            throw new LogicException('Not needed for this test.');
        }
